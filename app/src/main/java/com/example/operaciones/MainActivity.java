    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista_opciones.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        intent = new Intent(MainActivity.this, SeleccionarArea.class);
                        startActivity(intent);
                        break;

                    case 1:
                        intent = new Intent(MainActivity.this, SeleccionarVolumen.class);
                        startActivity(intent);
                        break;

                    case 2:
                        intent = new Intent(MainActivity.this, SeleccionarOperacionesRealizadas.class);
                        startActivity(intent);
                        break;
