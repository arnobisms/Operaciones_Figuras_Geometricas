...
public class SeleccionarOperacionesRealizadas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seleccionar_operaciones_realizadas);
        ...
        for (int i = 0; i < operaciones.size(); i++) {
            ...
            columna_dos.setText(operaciones.get(i).getDescripcion_operacion());
